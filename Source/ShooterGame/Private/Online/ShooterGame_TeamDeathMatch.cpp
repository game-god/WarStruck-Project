...
AShooterGame_TeamDeathMatch::AShooterGame_TeamDeathMatch(const class FPostConstructInitializeProperties& PCIP) : Super(PCIP)
{
	NumTeams = 2;
	bDelayedStart = true;
}

void AShooterGame_TeamDeathMatch::InitNewPlayer(AController* NewPlayer, const TSharedPtr<FUniqueNetId>& UniqueId, const FString& Options)
{
